...
export default function Roles() {
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <EditRoleDialog user={selectedUser} open={editDialogOpen} onOpenChange={setEditDialogOpen} />
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <span className="font-semibold">{userToDelete?.email}</span> and all their associated
